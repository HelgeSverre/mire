...
type Rect =
    ...
    member this.Size = { Width = this.Width; Height = this.Height }
    ...
    member this.Intersects(other: Rect) =
        not (other.Right < this.Left || other.Left > this.Right ||
    ...
    member this.ClipTo(clipRect: Rect) =
        this.Intersect(clipRect)
